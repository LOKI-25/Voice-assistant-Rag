...
class AIVoiceAssistant:
    def __init__(self):
        ...
        self._llm = Ollama(model="llama3", request_timeout=120.0)
        self._service_context = ServiceContext.from_defaults(llm=self._llm, embed_model=None)
        self._index = None
        self._create_kb()
    ...
    def _create_kb(self):
        try:
            reader = SimpleDirectoryReader(
                input_files=[r"/Users/apple/Desktop/voice_assistant_llm/rag/restaurant_file.txt"]
            )
